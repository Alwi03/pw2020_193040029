...
<body>
  <h1>
    <marquee bgcolor="#3ec7b0">WELCOME</b></marquee>
  </h1>
  <br>
  <div class="footer">
  ...
  <br>
  <table border="6" align="center" width="65%" cellspacing="12" cellpadding="5" <tr bgcolor="#9fd1cf">
    ...
    <tr>
      <td align="center"><?= $i; ?>.</td>
      <td><a href="praktikum/p<?= $no; ?>_SENIN13_193040029">Klik Disini</a></td>
      <td align="center">P<?= $no; ?>_SENIN13_193040029</td>
    </tr>
  <?php $i++;
      endfor; ?>
  </tr>
